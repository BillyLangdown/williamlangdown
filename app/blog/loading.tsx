  ...
  return (
    ...
    >
      ...
      <div className="p-6 md:p-7">
        <div className="h-5 w-20 rounded-sm animate-pulse mb-4" style={{ background: 'rgba(16,35,63,0.07)' }} />
        ...
        <div className="h-4 w-5/6 rounded-sm animate-pulse mb-5" style={{ background: 'rgba(16,35,63,0.05)' }} />
        <div className="flex justify-between">
          <div className="h-3 w-24 rounded-sm animate-pulse" style={{ background: 'rgba(16,35,63,0.04)' }} />
          <div className="h-3 w-16 rounded-sm animate-pulse" style={{ background: 'rgba(16,35,63,0.04)' }} />
        </div>
      </div>
    </div>
  )
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="pl-4 border-l-4 border-accent">
              <div className="h-12 w-64 rounded-sm animate-pulse mb-3" style={{ background: 'rgba(16,35,63,0.08)' }} />
              <div className="h-5 w-80 rounded-sm animate-pulse" style={{ background: 'rgba(16,35,63,0.05)' }} />
            </div>
          </div>
        </section>
