...
export default function Preview2Layout({ children }: { children: React.ReactNode }) {
  return (
    <MotionConfig reducedMotion="user">
      <div
        className={`${cagliostro.variable} min-h-dvh flex flex-col`}
        style={{ background: '#FBF6EF', color: '#3A322A', ...willowTexture }}
      >
        ...
        <footer className="px-6 py-10 mt-10" style={{ background: '#F1E7D8', ...willowTexture }}>
