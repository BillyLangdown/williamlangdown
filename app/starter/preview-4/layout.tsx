  ...
  return (
    <MotionConfig reducedMotion="user">
      <div className={`${cormorant.variable} min-h-dvh flex flex-col`} style={{ background: '#FAFAF8', color: '#1C1B19' }}>
        <PageIntro bg="#FAFAF8" textColor="#1C1B19" accentColor="#A8683D" label="Maren Voss" />
...
function PreviewBanner() {
  return (
    <div className="px-4 py-2.5 text-center text-xs font-medium" style={{ background: '#A8683D', color: '#FFFFFF' }}>
