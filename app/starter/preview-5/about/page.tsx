    ...
    <section className="px-6 py-24">
      <div className="max-w-5xl mx-auto">
        <Reveal>
          ...
          <h1 style={{ fontFamily: 'var(--font-space-grotesk)' }} className="text-4xl md:text-5xl font-semibold leading-tight tracking-tight text-white max-w-2xl">
            Infrastructure, run by people who&apos;ve been paged at 3am
          </h1>
        </Reveal>
        <Reveal delay={0.1} className="mt-10 max-w-2xl flex flex-col gap-5 text-slate-400 leading-relaxed">
          <p>
