...
export default function FeaturedProject({
  ...
  return (
    <section data-nav-theme="light" className="relative z-10 overflow-hidden bg-bone" style={{ scrollSnapAlign: 'start' }}>
      <SectionNav />
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        <ScrollReveal delay={80} className="mt-10 md:mt-12">
          <div
            className="grid grid-cols-[44%_1fr] md:grid-cols-[32fr_9fr] items-end md:items-start gap-4 md:gap-x-4 md:gap-y-8 [grid-template-areas:'main_main'_'mockup_info'] md:[grid-template-areas:'main_mockup'_'info_info']"
          >
